...
public class Utils {
    ...
    public static SparkSession getSparkSession(String wareHousePath, String thriftURL) {
        ...
        SparkSession sparkSession = SparkSession.builder()
                ...
                .config("spark.sql.catalog.spark_catalog.io-impl", "org.apache.iceberg.CustomFileIO")
    ...
    public static void injectFileIOConfigs(SparkSession spark, String oldBasePath, String newBasePath) {
        spark.sparkContext().hadoopConfiguration().set("fs.baseuri", newBasePath);
        spark.sparkContext().hadoopConfiguration().set("fs.oldbaseuri", oldBasePath);
    }
